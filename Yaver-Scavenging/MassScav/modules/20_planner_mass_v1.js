  ...
  Y.plan.build = function (cfg, selectedVillageIds) {
    ...
    for (var vi = 0; vi < vidList.length; vi++) {
      ...
      if (mode === "priority") {
        ...
        // distribute remainder to min time
        var remB = totalBaseCarryAvail - sum;
