(function () {
  ...
  function ensureStyle() {
    ...
    st.textContent = `
      ...
      #${PANEL_ID} .scroll{ max-height: 240px; overflow:auto; border:1px solid rgba(0,0,0,.15); }
      #${PANEL_ID} .scroll2{ max-height: 300px; overflow:auto; border:1px solid rgba(0,0,0,.15); }
      #${PANEL_ID} .badge{
