(function () {
    ...
    el.innerHTML = `
      <table class="vis">
        ...
        <tr>
          <td>
            <div class="toolbar">
              <span class="icon header time"></span><b>Duration:</b>
              <span class="timebox">
                <label>Hours <input id="yms_h_v1" type="number" min="0"></label>
                <label>Min <input id="yms_m_v1" type="number" min="0" max="59"></label>
                <label>Sec <input id="yms_s_v1" type="number" min="0" max="59"></label>
              </span>
            ...
            <div id="yms_msg_v1" class="info_box" style="margin-top:8px;">
              <div class="content">
                1) Select group → <b>LOAD DATA</b>  2) Select villages (checkbox)  3) PLAN  4) BUILD BATCHES  5) SEND NEXT (batch by batch)
              </div>
            </div>
          </td>
        </tr>
      ...
      <table class="vis">
        <tr><th style="text-align:left;">1) Group selection (checkbox)</th></tr>
        <tr>
          <td>
            <div id="yms_groups_v1" class="scroll" style="padding:6px;"></div>
            <div class="small muted" style="margin-top:6px;">Note: Selecting a group also auto-selects villages in that group. You can disable villages one by one in the village list if you want.</div>
          </td>
        </tr>
      </table>
      ...
      <table class="vis">
        <tr><th style="text-align:left;">2) Unit selection + Keep Home</th></tr>
      ...
      <table class="vis">
        <tr><th style="text-align:left;">3) Category selection (LOCKED/ACTIVE auto-skip)</th></tr>
      ...
      <table class="vis">
        <tr>
          <th style="text-align:left;">
            4) Village list (selection)
            <span style="float:right;">
              Search: <input id="yms_v_search_v1" type="text" style="width:240px;" placeholder="village name / coordinate">
            </span>
          </th>
        </tr>
        <tr>
      ...
      <table class="vis">
        <tr><th style="text-align:left;">6) Total resource income (Plan)</th></tr>
        <tr>
          <td>
            <table class="vis" style="width:100%; text-align:center;">
              <tr>
                <td style="width:25%;"><span class="icon header wood"></span><br><b id="yms_tot_wood_v1">0</b></td>
                <td style="width:25%;"><span class="icon header stone"></span><br><b id="yms_tot_stone_v1">0</b></td>
                <td style="width:25%;"><span class="icon header iron"></span><br><b id="yms_tot_iron_v1">0</b></td>
                <td style="width:25%; border-left:2px solid #cda261; background:#e8dcb3;">
                  <span class="icon header res"></span><br><b id="yms_tot_all_v1" style="color:#005c00;">0</b>
                </td>
              </tr>
            </table>
            <div class="small muted" style="margin-top:6px;">
              Note: This total is the sum of “Est Loot” values of OK rows in the plan table.
            </div>
          </td>
        </tr>
      </table>
      ...
      <table class="vis">
        <tr><th style="text-align:left;">7) Batch sending (200 limit)</th></tr>
        <tr>
          <td>
            <div class="scroll">
              <table class="vis">
            ...
            <div class="small muted" style="margin-top:6px;">
              SEND NEXT sends the next batch. You can also send batches one by one from the batch table.
            </div>
          </td>
        </tr>
      </table>
  ...
  Y.ui.renderPlan = function () {
    ...
    for (var i = 0; i < rows.length; i++) {
      ...
      totW += Number((r.loot && r.loot.wood) || 0);
      totS += Number((r.loot && r.loot.stone) || 0);
      totI += Number((r.loot && r.loot.iron) || 0);
    ...
    var wEl = document.getElementById("yms_tot_wood_v1");
    var sEl = document.getElementById("yms_tot_stone_v1");
    var iEl = document.getElementById("yms_tot_iron_v1");
    var aEl = document.getElementById("yms_tot_all_v1");
