(function () {
  ...
  Y.ui.ensure = function () {
    ...
    el.innerHTML = `
      ...
      <table class="vis">
        <tr><th style="text-align:left;">6) Toplam Kaynak Geliri (Plan)</th></tr>
        <tr>
          <td>
            ...
            <div class="small muted" style="margin-top:6px;">
              Not: Bu toplam, plan tablosundaki OK satırların “Est Loot” değerlerinin toplamıdır.
            </div>
          </td>
        </tr>
      </table>
      ...
      <table class="vis">
        <tr><th style="text-align:left;">7) Batch Gönderim (200 limit)</th></tr>
        <tr>
          <td>
            <div class="scroll">
              <table class="vis">
