(function () {
  ...
  function loadOne(file) {
    return new Promise(function (resolve, reject) {
      ...
      s.onload = function () {
        console.log("[YSS Loader v4] OK:", file);
        resolve(true);
      };
      s.onerror = function () {
        console.log("[YSS Loader v4] FAIL:", file, s.src);
