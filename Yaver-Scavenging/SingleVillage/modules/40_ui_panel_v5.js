(function () {
  ...
  Y.ui.ensureUI = function () {
    ...
    el.innerHTML = `
          ...
          <th style="text-align:left;">
            <div class="yss_hdr" id="yss_drag_v5">
              <div>
                ...
                Yaver Scavenging (Single Village) <span class="grey">(v5)</span>
              </div>
          ...
          <td>
            <div class="yss_toolbar">
              ...
              <span class="yss_timebox">
                <label>Saat <input id="yss_h_v5" type="number" step="1" min="0"></label>
                <label>Dk <input id="yss_m_v5" type="number" step="1" min="0" max="59"></label>
                <label>Sn <input id="yss_s_v5" type="number" step="1" min="0" max="59"></label>
              </span>
            ...
            <div id="yss_msg_v5" class="info_box" style="margin-top:8px;">
              <div class="content">Hazır. Süre/Unit/Kategori seç → <b>PLAN</b>. START ile plan satırlarını otomatik başlat.</div>
            </div>
          </td>
        </tr>
      </table>
      ...
      <table class="vis" style="width:100%;">
        <tr><th style="text-align:left;">Plan Toplamı (Tahmini Loot)</th></tr>
        <tr>
          <td>
            ...
            <div class="yss_small" style="margin-top:6px;">
              Not: Bu toplamlar plan tablosundaki “Est. Loot” değerlerinin toplamıdır.
            </div>
          </td>
        </tr>
      </table>
  ...
  Y.ui.renderPlan = function (plan, targetSec) {
    ...
    if (!plan || !plan.length) {
      tb.innerHTML = '<tr><td colspan="8" style="text-align:center;">Plan yok.</td></tr>';
    } else {
