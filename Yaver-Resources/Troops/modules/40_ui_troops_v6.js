(function () {
    ...
    el.innerHTML = `
      <div class="hdr" id="yrt_drag_handle" style="cursor:move;">
        <div style="font-weight:bold; font-size:14px;">
          ...
          Yaver Resources: Troops <span style="color:#555; font-size:11px;">(v6)</span>
        </div>
      ...
      <div class="toolbar">
        ...
        <span id="yrt_prog_txt_v1" style="font-size:11px;">Bekleniyor...</span>
      </div>

      <div id="yrt_msg_v1" class="msg">Hazır. (Panel içerik kadar boyutlanır.)</div>

      <div style="background:#e3d5b3; padding:4px; font-weight:bold; border:1px solid #7d510f; border-bottom:none;">
        1) Köy Bazlı Askerler
      </div>
  ...
  function setProgress(done, total) {
    ...
    if (txt) txt.textContent = total > 0 ? (done + "/" + total) : "Hazır.";
  }
