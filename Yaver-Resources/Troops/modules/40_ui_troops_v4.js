(function () {
  ...
  var PANEL_ID = "yaver_res_troops_panel_v2";     // aynı
  var STYLE_ID = "yaver_res_troops_style_v2";     // destroy bunu zaten siliyor
  ...
  function ensureStyle() {
    ...
    st.textContent = `
      ...
      #${PANEL_ID} table.vis { width:100%; background:#f4e4bc; margin:0; border-collapse: collapse; }
      #${PANEL_ID} td, #${PANEL_ID} th { background: transparent; vertical-align: top; }

      #${PANEL_ID} .hdr{ display:flex; align-items:center; justify-content:space-between; user-select:none; }
      ...
      /* ===== Kritik: scroll içindeki tablo %100 DEĞİL =====
         Bu sayede Troops sütunu "boşlukla şişmez" */
      #${PANEL_ID} .scroll table.vis{
        width: max-content;       /* içerik kadar */
        table-layout: auto;
        border-collapse: collapse; /* header kopukluğu biter */
      }

      /* Kolonlar içerik kadar: */
      #${PANEL_ID} .yrt_village{ white-space: nowrap; width: 1%; }
      #${PANEL_ID} .yrt_troops_cell{ white-space: nowrap; width: 1%; }
      #${PANEL_ID} .yrt_pop_cell{
        white-space: nowrap;
        width: 1%;
        padding-right: 22px; /* scrollbar güvenliği */
      }

      /* Unit kutuları: 0 olan yok, kalanlar yan yana uzasın */
      #${PANEL_ID} .units_cell{
        display: inline-flex;
        flex-wrap: nowrap;
        gap:10px;
          ...
          <th style="text-align:left;">
            <div class="hdr">
              <div>
                ...
                Yaver Resources: Troops <span class="grey">(v4)</span>
              </div>
              <div class="hdr_right">
          ...
          <td>
            <div class="scroll">
              <table class="vis">
                <thead>
                  <tr>
                    <th class="yrt_village">Village</th>
                    <th class="yrt_troops_cell">Troops</th>
                    <th class="right yrt_pop_cell">
          ...
          <td>
            <table class="vis">
              <tr>
                ...
                <td class="right" style="width:200px; padding-left:10px;">
                  <span class="icon header population"></span>
  ...
  Y.ui.renderPerVillage = function () {
    ...
    arr.forEach(function (pv) {
      ...
      tr.innerHTML =
        "<td class='yrt_village'><b>" + pv.name + "</b></td>" +
        "<td class='yrt_troops_cell'><div class='units_cell'>" + (boxes.join("") || "<span class='small'>-</span>") + "</div></td>" +
        "<td class='right yrt_pop_cell'><b>" + Y.util.n(pv.popTotal || 0) + "</b></td>";
