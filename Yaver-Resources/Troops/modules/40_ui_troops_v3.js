(function () {
  ...
  var PANEL_ID = "yaver_res_troops_panel_v2";   // aynı kalsın (destroy uyumu)
  var STYLE_ID = "yaver_res_troops_style_v3";   // style v3
  ...
  function ensureStyle() {
    ...
    st.textContent = `
      ...
      /* ===== Kritik: scroll içindeki tablo içerik kadar genişlesin ===== */
      #${PANEL_ID} .scroll{
        max-height: 320px;
        overflow: auto;
        overflow-x: auto;
      ...
      /* Scroll içindeki table: artık %100 değil, içerik kadar */
      #${PANEL_ID} .scroll table.vis{
        width: auto !important;
        display: inline-table;
      }

      /* Village hücresi: en uzun isim kadar, boş yere uzamasın */
      #${PANEL_ID} .yrt_village{ white-space: nowrap; }

      /* Troops hücresi: içerik kadar */
      #${PANEL_ID} .yrt_troops_cell{ white-space: nowrap; }

      /* Pop hücresi: Troops biter bitmez gelsin; scrollbar bindirmesin */
      #${PANEL_ID} .yrt_pop_cell{
        white-space: nowrap;
        padding-right: 22px;
      }

      /* Unit kutuları: sadece varsa render ediliyor zaten */
      #${PANEL_ID} .units_cell{
        display: inline-flex;
        gap:10px;
          ...
          <th style="text-align:left;">
            <div class="hdr">
              <div>
                ...
                Yaver Resources: Troops <span class="grey">(v3)</span>
              </div>
              <div class="hdr_right">
  ...
  function unitBoxHTML(u, count, perDay) {
    ...
    if (!(cnt > 0)) return ""; // 0 ise gösterme
