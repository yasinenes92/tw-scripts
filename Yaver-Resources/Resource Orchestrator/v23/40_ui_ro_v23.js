...
<div id="yro_content_v23">
  ...
  <div class="yro_msg yro_plan_diag" id="yro_plan_diag_v23">Diagnostics: -</div>

  <div class="yro_sec_head">
    <div id="yro_plan_target_title_v23">CHILDREN</div>
    <div class="yro_sec_controls yro_table_tools">
      <button class="yro_mini" id="yro_copy_plan_target_v23">Copy CHILDREN</button>
    </div>
  </div>
  ...
  <div class="yro_sec_head">
    <div id="yro_plan_surplus_title_v23">PARENTS</div>
    <div class="yro_sec_controls yro_table_tools">
      <button class="yro_mini" id="yro_copy_plan_surplus_v23">Copy PARENTS</button>
    </div>
  </div>
  ...
  <div class="yro_sec_head">
    <div id="yro_plan_ship_title_v23">SHIPMENTS</div>
    <div class="yro_sec_controls yro_table_tools">
      <button class="yro_mini" id="yro_copy_plan_ship_v23">Copy SHIPMENTS</button>
    </div>
  </div>
  <div class="yro_scroll" style="margin-top:8px;">
...
<tr class="yro_total_row">
  ...
  function renderPlanTables(plan, snapshotsById) {
    ...
    var diagEl = Y.qs('#yro_plan_diag_v23');
    var tTbl = Y.qs('#yro_plan_target_tbl_v23');
    var sTbl = Y.qs('#yro_plan_surplus_tbl_v23');
    var shTbl = Y.qs('#yro_plan_ship_tbl_v23');
    var targetTitleEl = Y.qs('#yro_plan_target_title_v23');
    var surplusTitleEl = Y.qs('#yro_plan_surplus_title_v23');
    var shipTitleEl = Y.qs('#yro_plan_ship_title_v23');
    var copyTargetEl = Y.qs('#yro_copy_plan_target_v23');
    var copySurplusEl = Y.qs('#yro_copy_plan_surplus_v23');
    var copyShipEl = Y.qs('#yro_copy_plan_ship_v23');
