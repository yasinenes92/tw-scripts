(function () {
  ...
  function copyPlanSurplusBBCode() {
    ...
    flashButton('#yro_copy_plan_surplus_v23', 'Copy SURPLUS');
  ...
  function copyPlanShipmentsBBCode() {
    ...
    flashButton('#yro_copy_plan_ship_v23', 'Copy SHIPMENTS');
  ...
  function bindEvents() {
    ...
    Y.on(Y.qs('#yro_copy_plan_target_v23'), 'click', function () { copyPlanTargetBBCode(); });
    Y.on(Y.qs('#yro_copy_plan_surplus_v23'), 'click', function () { copyPlanSurplusBBCode(); });
    Y.on(Y.qs('#yro_copy_plan_ship_v23'), 'click', function () { copyPlanShipmentsBBCode(); });
