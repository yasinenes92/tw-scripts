...
<div class="yro_mode_row ${(st.orchestrator.mode === 'coin' || st.orchestrator.mode === 'funnel') ? 'active' : ''}" data-mode="coin">
  ...
  <div class="yro_mode_controls">
    <div class="yro_kv"><label>Sources</label><select id="yro_C_sources_v27">${optionsHTML(st.groups.C_sources)}</select></div>
    <button class="yro_mini" id="pick_C_sources_v27">Pick...</button>
    <div class="yro_kv"><label>Coin</label><select id="yro_C_coin_v27">${optionsHTML(st.groups.C_coin)}</select></div>
    <button class="yro_mini" id="pick_C_coin_v27">Pick...</button>
    <div class="yro_kv"><label>Buffer / Surplus</label><select id="yro_C_buffer_v27">${optionsHTML(st.groups.C_buffer)}</select></div>
    <button class="yro_mini" id="pick_C_buffer_v27">Pick...</button>
    <div class="yro_kv"><label>Source Reserve %</label><input id="yro_C_reserve_v27" type="number" min="0" max="100" step="1" value="${st.modeC.sourceReservePct}" style="width:72px;"></div>
    <div class="yro_kv"><label>Buffer Cap %</label><input id="yro_C_bcap_v27" type="number" min="0" max="100" step="1" value="${st.modeC.bufferCapPct}" style="width:70px;"></div>
    <div class="yro_kv"><label>Additional Coins</label><input id="yro_C_additional_coins_v27" type="number" value="" style="width:84px;" disabled></div>
    <div class="yro_kv"><label>Merch Used</label><input id="yro_C_merch_used_v27" type="number" value="" style="width:72px;" disabled></div>
...
<tr class="yro_total_row">
  ...
  function renderPlanTables(plan, snapshotsById) {
    ...
    function renderEmpty() {
      ...
      var modeCCoinsEl = Y.qs('#yro_C_additional_coins_v27');
      var modeCMerchEl = Y.qs('#yro_C_merch_used_v27');
    ...
    if (String(plan.mode || '').toLowerCase() === 'balance' && plan.targetSummary) {
      ...
      var coinAddEl0 = Y.qs('#yro_C_additional_coins_v27');
      var coinMerchEl0 = Y.qs('#yro_C_merch_used_v27');
...
<tr>
  ...
  <td class="yro_right">${Y.formatTwNumber(r.after.iron)}</td>
      ...
      var coinAddEl1 = Y.qs('#yro_C_additional_coins_v27');
      var coinMerchEl1 = Y.qs('#yro_C_merch_used_v27');
...
<tr>
  ...
  <td class="yro_right">${Y.formatTwNumber(r.after.iron)}</td>
      ...
      var computedFillElC0 = Y.qs('#yro_B_computed_fill_v27');
      var childMerchElC0 = Y.qs('#yro_B_child_merch_v27');
      var parentMerchElC0 = Y.qs('#yro_B_parent_merch_v27');
      var modeAFillElC0 = Y.qs('#yro_A_computed_fill_v27');
      var modeAMerchElC0 = Y.qs('#yro_A_merch_used_v27');
      var modeCCoinsEl = Y.qs('#yro_C_additional_coins_v27');
      var modeCMerchEl = Y.qs('#yro_C_merch_used_v27');
...
<tr>
  ...
  <td class="yro_right">${Y.formatTwNumber(r.after.iron)}</td>
      ...
      var modeCCoinsEl2 = Y.qs('#yro_C_additional_coins_v27');
      var modeCMerchEl2 = Y.qs('#yro_C_merch_used_v27');
