(function () {
  ...
  async function planFromMode(mode) {
    ...
    if (mode === 'balance') {
      ...
      var sourceGid = getSelValue('#yro_C_sources_v27');
      var coinGid = getSelValue('#yro_C_coin_v27');
      var bufferGid = getSelValue('#yro_C_buffer_v27');
      var sourceReservePct = getNumValue('#yro_C_reserve_v27', st.modeC.sourceReservePct || 1);
      var bufferCapPct = getNumValue('#yro_C_bcap_v27', st.modeC.bufferCapPct || 95);
  ...
  function copyPlanTargetBBCode() {
    ...
    if (mode === 'coin') {
      ...
      flashButton('#yro_copy_plan_target_v27', 'Copy COIN VILLAGES');
  ...
  function copyPlanSurplusBBCode() {
    ...
    if (mode === 'coin') {
      ...
      flashButton('#yro_copy_plan_surplus_v27', (plan.bufferSummary && plan.bufferSummary.length) ? 'Copy SOURCES / BUFFER' : 'Copy SOURCES');
  ...
  function bindEvents() {
    ...
    Y.on(modeBox, 'click', function (e) {
      ...
      if (t.id === 'yro_C_plan_v27') return planFromMode('coin');
    ...
    Y.on(modeBox, 'change', function (e) {
      ...
      else if (t.id === 'yro_C_sources_v27') st.groups.C_sources = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_C_coin_v27') st.groups.C_coin = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_C_buffer_v27') st.groups.C_buffer = Y.safeInt(t.value, 0);
      ...
      else if (t.id === 'yro_C_reserve_v27') st.modeC.sourceReservePct = Y.safeInt(t.value, st.modeC.sourceReservePct);
      else if (t.id === 'yro_C_bcap_v27') st.modeC.bufferCapPct = Y.safeInt(t.value, st.modeC.bufferCapPct);
