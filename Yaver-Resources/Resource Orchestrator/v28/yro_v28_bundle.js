...
(function () {
  ...
  function planFunnel(allIds, targetIds, surplusIds, snapshotsById, incomingMap, capPct, surplusCapPct, reservePct, ironDeltaPct) {
    ...
    // v28: Sender list should NOT be nulled by Surplus selection; only exclude Targets.
...
/* Content scroll area */
#${Y.cfg.PANEL_ID} #yro_content_v28{
  padding:8px;
  flex:1;
  overflow-y:auto;
  overflow-x:auto;
...
#${Y.cfg.PICKER_OVERLAY_ID} .yro_modal_foot{
  ...
  gap:8px;
    ...
    root.innerHTML = `
<div class="yro_hdr" id="yro_drag_v28" style="cursor:move;">
  <div class="yro_ttl"><span class="icon header wood"></span> Resource Orchestrator <span class="yro_small">(v28)</span></div>
  <div style="display:flex; align-items:center;">
    ...
    <button class="yro_btn" id="yro_close_v28">X</button>
  </div>
</div>

<div class="yro_toolbar">
  <button class="yro_btn btn-confirm" id="yro_load_v28">Load / Refresh (Full Scan)</button>
  <div class="yro_progress_outer"><div class="yro_progress_inner" id="yro_prog_bar_v28"></div></div>
  <span id="yro_prog_txt_v28" class="yro_small">0/0 - Ready</span>

  <span class="yro_small"><b>Search:</b></span>
  <input type="text" id="yro_search_v28" placeholder="Village name..." style="width:180px;">

  <button class="yro_btn btn-confirm" id="yro_copy_bb_v28">Copy Test Results</button>
</div>

<div class="yro_msg" id="yro_msg_v28" style="color:#0a6;">Ready</div>

<div id="yro_content_v28">
  <div class="yro_sec_head">
    <div>1) Villages - Production (per hour + 24h) (<span id="yro_t1_title_v28">All villages</span>)</div>
    <div class="yro_sec_controls">
      <button class="yro_mini" id="yro_t1_toggle_v28">${st.ui.minimized1 ? 'Expand' : 'Minimize'}</button>
      <span class="yro_small"><b>Group:</b></span>
      <select id="yro_t1_group_sel_v28"></select>
      <button class="yro_mini" id="yro_t1_pick_v28">Pick...</button>
    </div>
  </div>
  <div class="yro_scroll" id="yro_t1_wrap_v28" style="${st.ui.minimized1 ? 'display:none;' : ''}">
    <table class="yro_table" id="yro_t1_tbl_v28"></table>
  </div>

  <div class="yro_sec_head">
    <div>2) Villages - Current + Incoming + Outgoing (per village) (<span id="yro_t2_title_v28">All villages</span>)</div>
    <div class="yro_sec_controls">
      <button class="yro_mini" id="yro_t2_toggle_v28">${st.ui.minimized2 ? 'Expand' : 'Minimize'}</button>
      <span class="yro_small"><b>Group:</b></span>
      <select id="yro_t2_group_sel_v28"></select>
      <button class="yro_mini" id="yro_t2_pick_v28">Pick...</button>
      <span class="yro_small" id="yro_scan_ts_v28"></span>
    </div>
  </div>
  <div class="yro_scroll" id="yro_t2_wrap_v28" style="${st.ui.minimized2 ? 'display:none;' : ''}">
    <table class="yro_table" id="yro_t2_tbl_v28"></table>
  </div>
  ...
  <div class="yro_mode_box" id="yro_modes_v28"></div>

  <div class="yro_msg" id="yro_plan_meta_v28" style="margin-top:8px;">
    <b>Mode:</b> - | <b>Computed Fill %:</b> - | <b>Cap Ceiling %:</b> - | <b>Surplus Cap %:</b> - | <b>Merch Used:</b> - | <b>Shipments:</b> 0 | <b>Warnings:</b> -
  </div>

  <div class="yro_msg yro_plan_diag" id="yro_plan_diag_v28">Diagnostics: -</div>

  <div class="yro_sec_head">
    <div id="yro_plan_target_title_v28">TARGET GROUP</div>
    <div class="yro_sec_controls yro_table_tools">
      <button class="yro_mini" id="yro_copy_plan_target_v28">Copy TARGET GROUP</button>
    </div>
  </div>
  <div class="yro_scroll">
    <table class="yro_table" id="yro_plan_target_tbl_v28"></table>
  </div>

  <div class="yro_sec_head">
    <div id="yro_plan_surplus_title_v28">SURPLUS</div>
    <div class="yro_sec_controls yro_table_tools">
      <button class="yro_mini" id="yro_copy_plan_surplus_v28">Copy SURPLUS</button>
    </div>
  </div>
  <div class="yro_scroll" style="margin-top:8px;">
    <table class="yro_table" id="yro_plan_surplus_tbl_v28"></table>
  </div>

  <div class="yro_sec_head">
    <div id="yro_plan_ship_title_v28">SHIPMENTS</div>
    <div class="yro_sec_controls yro_table_tools">
      <button class="yro_mini" id="yro_copy_plan_ship_v28">Copy SHIPMENTS</button>
    </div>
  </div>
  <div class="yro_scroll" style="margin-top:8px;">
    <table class="yro_table" id="yro_plan_ship_tbl_v28"></table>
  </div>
</div>
    `;
  ...
  function setProgress(step, total, text) {
    var bar = Y.qs('#yro_prog_bar_v28');
    var tx = Y.qs('#yro_prog_txt_v28');
    if (!bar || !tx) return;
  ...
  function fillGroupSelects(groups) {
    ...
    fill('#yro_t1_group_sel_v28', st.groups.sel1);
    fill('#yro_t2_group_sel_v28', st.groups.sel2);
  }
...
<div class="yro_mode_row ${st.orchestrator.mode === 'balance' ? 'active' : ''}" data-mode="balance">
  ...
  <div class="yro_mode_controls">
    <div class="yro_kv"><label>Target</label><select id="yro_A_target_v28">${optionsHTML(st.groups.A_target)}</select></div>
    <button class="yro_mini" id="pick_A_target_v28">Pick...</button>
    <div class="yro_kv"><label>Surplus</label><select id="yro_A_surplus_v28">${optionsHTML(st.groups.A_surplus)}</select></div>
    <button class="yro_mini" id="pick_A_surplus_v28">Pick...</button>
    <div class="yro_kv"><label>Cap%</label><input id="yro_A_cap_v28" type="number" min="1" max="100" step="1" value="${st.modeA.capPct}" style="width:60px;"></div>
    <div class="yro_kv"><label>Surplus Cap%</label><input id="yro_A_scap_v28" type="number" min="1" max="100" step="1" value="${st.modeA.surplusCapPct}" style="width:60px;"></div>
    <div class="yro_kv"><label>Computed Fill %</label><input id="yro_A_computed_fill_v28" type="number" value="" style="width:78px;" disabled></div>
    <div class="yro_kv"><label>Merch Used</label><input id="yro_A_merch_used_v28" type="number" value="" style="width:70px;" disabled></div>
    <button class="yro_btn btn-confirm" id="yro_A_plan_v28">Plan</button>
    <button class="yro_btn btn-confirm" id="yro_A_exec_v28">Execute</button>
  </div>
</div>
...
<div class="yro_mode_row ${st.orchestrator.mode === 'push' ? 'active' : ''}" data-mode="push">
  ...
  <div class="yro_mode_controls">
    <div class="yro_kv"><label>Parents</label><select id="yro_B_parents_v28">${optionsHTML(st.groups.B_parents)}</select></div>
    <button class="yro_mini" id="pick_B_parents_v28">Pick...</button>
    <div class="yro_kv"><label>Children</label><select id="yro_B_children_v28">${optionsHTML(st.groups.B_children)}</select></div>
    <button class="yro_mini" id="pick_B_children_v28">Pick...</button>
    <div class="yro_kv"><label>Surplus</label><select id="yro_B_surplus_v28">${optionsHTML(st.groups.B_surplus)}</select></div>
    <button class="yro_mini" id="pick_B_surplus_v28">Pick...</button>
    <div class="yro_kv"><label>Parent Reserve %</label><input id="yro_B_parent_reserve_v28" type="number" min="0" max="100" step="1" value="${st.modeB.parentReservePct}" style="width:70px;"></div>
    <div class="yro_kv"><label>Children Max Fill %</label><input id="yro_B_child_max_v28" type="number" min="0" max="100" step="1" value="${st.modeB.childrenMaxFillPct}" style="width:78px;"></div>
    <div class="yro_kv"><label>Surplus Cap %</label><input id="yro_B_scap_v28" type="number" min="0" max="100" step="1" value="${st.modeB.surplusCapPct}" style="width:70px;"></div>
    <div class="yro_kv"><label>Computed Child Fill %</label><input id="yro_B_computed_fill_v28" type="number" value="" style="width:78px;" disabled></div>
    <div class="yro_kv"><label>Child Merch Used</label><input id="yro_B_child_merch_v28" type="number" value="" style="width:70px;" disabled></div>
    <div class="yro_kv"><label>Parent Merch Used</label><input id="yro_B_parent_merch_v28" type="number" value="" style="width:78px;" disabled></div>
    <button class="yro_btn btn-confirm" id="yro_B_plan_v28">Plan</button>
    <button class="yro_btn btn-confirm" id="yro_B_exec_v28">Execute</button>
  </div>
</div>
...
<div class="yro_mode_row ${(st.orchestrator.mode === 'coin' || st.orchestrator.mode === 'funnel') ? 'active' : ''}" data-mode="coin">
  ...
  <div class="yro_mode_controls">
    <div class="yro_kv"><label>Sources</label><select id="yro_C_sources_v28">${optionsHTML(st.groups.C_sources)}</select></div>
    <button class="yro_mini" id="pick_C_sources_v28">Pick...</button>
    <div class="yro_kv"><label>Coin</label><select id="yro_C_coin_v28">${optionsHTML(st.groups.C_coin)}</select></div>
    <button class="yro_mini" id="pick_C_coin_v28">Pick...</button>
    <div class="yro_kv"><label>Buffer / Surplus</label><select id="yro_C_buffer_v28">${optionsHTML(st.groups.C_buffer)}</select></div>
    <button class="yro_mini" id="pick_C_buffer_v28">Pick...</button>
    <div class="yro_kv"><label>Source Reserve %</label><input id="yro_C_reserve_v28" type="number" min="0" max="100" step="1" value="${st.modeC.sourceReservePct}" style="width:72px;"></div>
    <div class="yro_kv"><label>Buffer Cap %</label><input id="yro_C_bcap_v28" type="number" min="0" max="100" step="1" value="${st.modeC.bufferCapPct}" style="width:70px;"></div>
    <div class="yro_kv"><label>Additional Coins</label><input id="yro_C_additional_coins_v28" type="number" value="" style="width:84px;" disabled></div>
    <div class="yro_kv"><label>Merch Used</label><input id="yro_C_merch_used_v28" type="number" value="" style="width:72px;" disabled></div>
    <button class="yro_btn btn-confirm" id="yro_C_plan_v28">Plan</button>
    <button class="yro_btn btn-confirm" id="yro_C_exec_v28">Execute</button>
  </div>
</div>
    `;
  }
...
<div class="yro_modal_head">
  ...
  <button class="yro_btn" id="yro_picker_close_v28">Ã¢Å“â€“</button>
</div>
<div class="yro_modal_body">
  <div class="yro_modal_toolbar">
    <span class="yro_small"><b>Search:</b></span>
    <input type="text" id="yro_picker_search_v28" style="width:220px;" placeholder="name / coord">
    <button class="yro_btn" id="yro_picker_all_v28">Select all</button>
    <button class="yro_btn" id="yro_picker_none_v28">Select none</button>
    <span class="yro_small" id="yro_picker_count_v28"></span>
  </div>
  <table class="yro_modal_list" id="yro_picker_tbl_v28">
    <tr><th></th><th>Village</th><th>Coord</th><th class="yro_right">Storage</th></tr>
  </table>
</div>
<div class="yro_modal_foot">
  <button class="yro_btn" id="yro_picker_cancel_v28">Cancel</button>
  <button class="yro_btn btn-confirm" id="yro_picker_save_v28">Kaydet</button>
</div>
    `;
    ...
    function updateCount() {
      var el = box.querySelector('#yro_picker_count_v28');
      if (el) el.textContent = 'Selected: ' + selected.size;
    }

    function renderList(filterText) {
      filterText = String(filterText || '').toLowerCase();
      var tbl = box.querySelector('#yro_picker_tbl_v28');
      if (!tbl) return;
...
<td class="yro_right">${Y.formatTwNumber(storage)}</td>
    ...
    box.querySelector('#yro_picker_close_v28').addEventListener('click', close);
    box.querySelector('#yro_picker_cancel_v28').addEventListener('click', close);

    box.querySelector('#yro_picker_all_v28').addEventListener('click', function () {
      candidates.forEach(function (v) { selected.add(String(v.id)); });
      renderList(box.querySelector('#yro_picker_search_v28').value);
    });

    box.querySelector('#yro_picker_none_v28').addEventListener('click', function () {
      selected.clear();
      renderList(box.querySelector('#yro_picker_search_v28').value);
    });

    box.querySelector('#yro_picker_save_v28').addEventListener('click', function () {
      var ids = Array.from(selected).map(function (s) { return Y.safeInt(s, 0); }).filter(Boolean);
      try { onSaveCallback(ids); } catch (e) {}
      close();
    });

    box.querySelector('#yro_picker_search_v28').addEventListener('input', Y.debounce(function (e) {
...
<tr class="yro_total_row">
  ...
  function renderPlanTables(plan, snapshotsById) {
    var metaEl = Y.qs('#yro_plan_meta_v28');
    var diagEl = Y.qs('#yro_plan_diag_v28');
    var tTbl = Y.qs('#yro_plan_target_tbl_v28');
    var sTbl = Y.qs('#yro_plan_surplus_tbl_v28');
    var shTbl = Y.qs('#yro_plan_ship_tbl_v28');
    var targetTitleEl = Y.qs('#yro_plan_target_title_v28');
    var surplusTitleEl = Y.qs('#yro_plan_surplus_title_v28');
    var shipTitleEl = Y.qs('#yro_plan_ship_title_v28');
    var copyTargetEl = Y.qs('#yro_copy_plan_target_v28');
    var copySurplusEl = Y.qs('#yro_copy_plan_surplus_v28');
    var copyShipEl = Y.qs('#yro_copy_plan_ship_v28');

    function renderEmpty() {
      var modeAFillEl = Y.qs('#yro_A_computed_fill_v28');
      var modeAMerchEl = Y.qs('#yro_A_merch_used_v28');
      var modeBFillEl = Y.qs('#yro_B_computed_fill_v28');
      var modeBChildMerchEl = Y.qs('#yro_B_child_merch_v28');
      var modeBParentMerchEl = Y.qs('#yro_B_parent_merch_v28');
      var modeCCoinsEl = Y.qs('#yro_C_additional_coins_v28');
      var modeCMerchEl = Y.qs('#yro_C_merch_used_v28');
    ...
    if (String(plan.mode || '').toLowerCase() === 'balance' && plan.targetSummary) {
      ...
      var modeAFillEl = Y.qs('#yro_A_computed_fill_v28');
      var modeAMerchEl = Y.qs('#yro_A_merch_used_v28');
      var computedFillEl0 = Y.qs('#yro_B_computed_fill_v28');
      var childMerchEl0 = Y.qs('#yro_B_child_merch_v28');
      var parentMerchEl0 = Y.qs('#yro_B_parent_merch_v28');
      var coinAddEl0 = Y.qs('#yro_C_additional_coins_v28');
      var coinMerchEl0 = Y.qs('#yro_C_merch_used_v28');
...
<tr>
  ...
  <td class="yro_right">${Y.formatTwNumber(r.after.iron)}</td>
      ...
      var computedFillEl = Y.qs('#yro_B_computed_fill_v28');
      var childMerchEl = Y.qs('#yro_B_child_merch_v28');
      var parentMerchEl = Y.qs('#yro_B_parent_merch_v28');
      var modeAFillEl2 = Y.qs('#yro_A_computed_fill_v28');
      var modeAMerchEl2 = Y.qs('#yro_A_merch_used_v28');
      var coinAddEl1 = Y.qs('#yro_C_additional_coins_v28');
      var coinMerchEl1 = Y.qs('#yro_C_merch_used_v28');
...
<tr>
  ...
  <td class="yro_right">${Y.formatTwNumber(r.after.iron)}</td>
      ...
      var computedFillElC0 = Y.qs('#yro_B_computed_fill_v28');
      var childMerchElC0 = Y.qs('#yro_B_child_merch_v28');
      var parentMerchElC0 = Y.qs('#yro_B_parent_merch_v28');
      var modeAFillElC0 = Y.qs('#yro_A_computed_fill_v28');
      var modeAMerchElC0 = Y.qs('#yro_A_merch_used_v28');
      var modeCCoinsEl = Y.qs('#yro_C_additional_coins_v28');
      var modeCMerchEl = Y.qs('#yro_C_merch_used_v28');
...
<tr>
  ...
  <td class="yro_right">${Y.formatTwNumber(r.after.iron)}</td>
      ...
      var computedFillEl2 = Y.qs('#yro_B_computed_fill_v28');
      var childMerchEl2 = Y.qs('#yro_B_child_merch_v28');
      var parentMerchEl2 = Y.qs('#yro_B_parent_merch_v28');
      var modeAFillEl3 = Y.qs('#yro_A_computed_fill_v28');
      var modeAMerchEl3 = Y.qs('#yro_A_merch_used_v28');
      var modeCCoinsEl2 = Y.qs('#yro_C_additional_coins_v28');
      var modeCMerchEl2 = Y.qs('#yro_C_merch_used_v28');
