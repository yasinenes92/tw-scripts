(function () {
  ...
  var VERSION = 'v33';
  var NS = 'YRO_V33';
  var PANEL_ID = 'yro_panel_v33';
  var STYLE_ID = 'yro_css_v33';
  var PICKER_OVERLAY_ID = 'yro_picker_overlay_v33';
  var LS_KEY = 'YRO_V33_state';
  ...
  function cleanupOlderInstances() {
    ...
    try { if (window.YRO_V33) delete window.YRO_V33; } catch (e3) {}
...
/* Content scroll area */
#${Y.cfg.PANEL_ID} #yro_content_v33{
  padding:8px;
  flex:1;
  overflow-y:auto;
  overflow-x:auto;
...
#${Y.cfg.PICKER_OVERLAY_ID} .yro_modal_foot{
  ...
  gap:8px;
    ...
    root.innerHTML = `
<div class="yro_hdr" id="yro_drag_v33" style="cursor:move;">
  <div class="yro_ttl"><span class="icon header wood"></span> Resource Orchestrator <span class="yro_small">(v33)</span></div>
  <div style="display:flex; align-items:center;">
    ...
    <button class="yro_btn" id="yro_close_v33">X</button>
  </div>
</div>

<div class="yro_toolbar">
  <button class="yro_btn btn-confirm" id="yro_load_v33">Load / Refresh (Full Scan)</button>
  <div class="yro_progress_outer"><div class="yro_progress_inner" id="yro_prog_bar_v33"></div></div>
  <span id="yro_prog_txt_v33" class="yro_small">0/0 - Ready</span>

  <span class="yro_small"><b>Search:</b></span>
  <input type="text" id="yro_search_v33" placeholder="Village name..." style="width:180px;">

  <button class="yro_btn btn-confirm" id="yro_copy_bb_v33">Copy Test Results</button>
</div>

<div class="yro_msg" id="yro_msg_v33" style="color:#0a6;">Ready</div>

<div id="yro_content_v33">
  <div class="yro_sec_head">
    <div>1) Villages - Production (per hour + 24h) (<span id="yro_t1_title_v33">All villages</span>)</div>
    <div class="yro_sec_controls">
      <button class="yro_mini" id="yro_t1_toggle_v33">${st.ui.minimized1 ? 'Expand' : 'Minimize'}</button>
      <span class="yro_small"><b>Group:</b></span>
      <select id="yro_t1_group_sel_v33"></select>
      <button class="yro_mini" id="yro_t1_pick_v33">Pick...</button>
    </div>
  </div>
  <div class="yro_scroll" id="yro_t1_wrap_v33" style="${st.ui.minimized1 ? 'display:none;' : ''}">
    <table class="yro_table" id="yro_t1_tbl_v33"></table>
  </div>

  <div class="yro_sec_head">
    <div>2) Villages - Current + Incoming + Outgoing (per village) (<span id="yro_t2_title_v33">All villages</span>)</div>
    <div class="yro_sec_controls">
      <button class="yro_mini" id="yro_t2_toggle_v33">${st.ui.minimized2 ? 'Expand' : 'Minimize'}</button>
      <span class="yro_small"><b>Group:</b></span>
      <select id="yro_t2_group_sel_v33"></select>
      <button class="yro_mini" id="yro_t2_pick_v33">Pick...</button>
      <span class="yro_small" id="yro_scan_ts_v33"></span>
    </div>
  </div>
  <div class="yro_scroll" id="yro_t2_wrap_v33" style="${st.ui.minimized2 ? 'display:none;' : ''}">
    <table class="yro_table" id="yro_t2_tbl_v33"></table>
  </div>
  ...
  <div class="yro_mode_box" id="yro_modes_v33"></div>

  <div class="yro_msg" id="yro_plan_meta_v33" style="margin-top:8px;">
    <b>Mode:</b> - | <b>Computed Fill %:</b> - | <b>Cap Ceiling %:</b> - | <b>Surplus Cap %:</b> - | <b>Merch Used:</b> - | <b>Shipments:</b> 0 | <b>Warnings:</b> -
  </div>

  <div class="yro_msg yro_plan_diag" id="yro_plan_diag_v33">Diagnostics: -</div>

  <div class="yro_sec_head">
    <div id="yro_plan_target_title_v33">TARGET GROUP</div>
    <div class="yro_sec_controls yro_table_tools">
      <button class="yro_mini" id="yro_copy_plan_target_v33">Copy TARGET GROUP</button>
    </div>
  </div>
  <div class="yro_scroll">
    <table class="yro_table" id="yro_plan_target_tbl_v33"></table>
  </div>

  <div class="yro_sec_head">
    <div id="yro_plan_surplus_title_v33">SURPLUS</div>
    <div class="yro_sec_controls yro_table_tools">
      <button class="yro_mini" id="yro_copy_plan_surplus_v33">Copy SURPLUS</button>
    </div>
  </div>
  <div class="yro_scroll" style="margin-top:8px;">
    <table class="yro_table" id="yro_plan_surplus_tbl_v33"></table>
  </div>

  <div class="yro_sec_head">
    <div id="yro_plan_ship_title_v33">SHIPMENTS</div>
    <div class="yro_sec_controls yro_table_tools">
      <button class="yro_mini" id="yro_copy_plan_ship_v33">Copy SHIPMENTS</button>
    </div>
  </div>
  <div class="yro_scroll" style="margin-top:8px;">
    <table class="yro_table" id="yro_plan_ship_tbl_v33"></table>
  </div>
</div>
    `;
  ...
  function setProgress(step, total, text) {
    var bar = Y.qs('#yro_prog_bar_v33');
    var tx = Y.qs('#yro_prog_txt_v33');
    if (!bar || !tx) return;
  ...
  function fillGroupSelects(groups) {
    ...
    fill('#yro_t1_group_sel_v33', st.groups.sel1);
    fill('#yro_t2_group_sel_v33', st.groups.sel2);
  }
...
<div class="yro_mode_row ${st.orchestrator.mode === 'balance' ? 'active' : ''}" data-mode="balance">
  ...
  <div class="yro_mode_controls">
    <div class="yro_kv"><label>Target</label><select id="yro_A_target_v33">${optionsHTML(st.groups.A_target)}</select></div>
    <button class="yro_mini" id="pick_A_target_v33">Pick...</button>
    <div class="yro_kv"><label>Surplus</label><select id="yro_A_surplus_v33">${optionsHTML(st.groups.A_surplus)}</select></div>
    <button class="yro_mini" id="pick_A_surplus_v33">Pick...</button>
    <div class="yro_kv"><label>Balance Basis</label><select id="yro_A_basis_v33" style="width:180px;"><option value="fill"${modeABasis === 'fill' ? ' selected' : ''}>Equal Fill % by Storage</option><option value="flat"${modeABasis === 'flat' ? ' selected' : ''}>Equal Flat Amount per Village</option></select></div>
    <div class="yro_kv"><label>Cap%</label><input id="yro_A_cap_v33" type="number" min="0" max="100" step="1" value="${st.modeA.capPct}" style="width:60px;"${modeACapDisabled}></div>
    <div class="yro_kv"><label>Depot Cap %</label><input id="yro_A_depot_cap_v33" type="number" min="0" max="100" step="1" value="${st.modeA.depotCapPct}" style="width:70px;"${modeADepotDisabled}></div>
    <div class="yro_kv"><label>Surplus Cap%</label><input id="yro_A_scap_v33" type="number" min="1" max="100" step="1" value="${st.modeA.surplusCapPct}" style="width:60px;"></div>
    <div class="yro_kv"><label id="yro_A_computed_label_v33">${modeAComputedLabel}</label><input id="yro_A_computed_fill_v33" type="number" value="" style="width:92px;" disabled></div>
    <div class="yro_kv"><label>Merch Used</label><input id="yro_A_merch_used_v33" type="number" value="" style="width:70px;" disabled></div>
    <button class="yro_btn btn-confirm" id="yro_A_plan_v33">Plan</button>
    <button class="yro_btn btn-confirm" id="yro_A_exec_v33">Execute</button>
  </div>
</div>
...
<div class="yro_mode_row ${st.orchestrator.mode === 'push' ? 'active' : ''}" data-mode="push">
  ...
  <div class="yro_mode_controls">
    <div class="yro_kv"><label>Parents</label><select id="yro_B_parents_v33">${optionsHTML(st.groups.B_parents)}</select></div>
    <button class="yro_mini" id="pick_B_parents_v33">Pick...</button>
    <div class="yro_kv"><label>Children</label><select id="yro_B_children_v33">${optionsHTML(st.groups.B_children)}</select></div>
    <button class="yro_mini" id="pick_B_children_v33">Pick...</button>
    <div class="yro_kv"><label>Surplus</label><select id="yro_B_surplus_v33">${optionsHTML(st.groups.B_surplus)}</select></div>
    <button class="yro_mini" id="pick_B_surplus_v33">Pick...</button>
    <div class="yro_kv"><label>Parent Reserve %</label><input id="yro_B_parent_reserve_v33" type="number" min="0" max="100" step="1" value="${st.modeB.parentReservePct}" style="width:70px;"></div>
    <div class="yro_kv"><label>Children Max Fill %</label><input id="yro_B_child_max_v33" type="number" min="0" max="100" step="1" value="${st.modeB.childrenMaxFillPct}" style="width:78px;"></div>
    <div class="yro_kv"><label>Surplus Cap %</label><input id="yro_B_scap_v33" type="number" min="0" max="100" step="1" value="${st.modeB.surplusCapPct}" style="width:70px;"></div>
    <div class="yro_kv"><label>Computed Child Fill %</label><input id="yro_B_computed_fill_v33" type="number" value="" style="width:78px;" disabled></div>
    <div class="yro_kv"><label>Child Merch Used</label><input id="yro_B_child_merch_v33" type="number" value="" style="width:70px;" disabled></div>
    <div class="yro_kv"><label>Parent Merch Used</label><input id="yro_B_parent_merch_v33" type="number" value="" style="width:78px;" disabled></div>
    <button class="yro_btn btn-confirm" id="yro_B_plan_v33">Plan</button>
    <button class="yro_btn btn-confirm" id="yro_B_exec_v33">Execute</button>
  </div>
</div>
...
<div class="yro_mode_row ${(st.orchestrator.mode === 'coin' || st.orchestrator.mode === 'funnel') ? 'active' : ''}" data-mode="coin">
  ...
  <div class="yro_mode_controls">
    <div class="yro_kv"><label>Sources</label><select id="yro_C_sources_v33">${optionsHTML(st.groups.C_sources)}</select></div>
    <button class="yro_mini" id="pick_C_sources_v33">Pick...</button>
    <div class="yro_kv"><label>Coin</label><select id="yro_C_coin_v33">${optionsHTML(st.groups.C_coin)}</select></div>
    <button class="yro_mini" id="pick_C_coin_v33">Pick...</button>
    <div class="yro_kv"><label>Buffer / Surplus</label><select id="yro_C_buffer_v33">${optionsHTML(st.groups.C_buffer)}</select></div>
    <button class="yro_mini" id="pick_C_buffer_v33">Pick...</button>
    <div class="yro_kv"><label>Source Reserve %</label><input id="yro_C_reserve_v33" type="number" min="0" max="100" step="1" value="${st.modeC.sourceReservePct}" style="width:72px;"></div>
    <div class="yro_kv"><label>Buffer Cap %</label><input id="yro_C_bcap_v33" type="number" min="0" max="100" step="1" value="${st.modeC.bufferCapPct}" style="width:70px;"></div>
    <div class="yro_kv"><label>Additional Coins</label><input id="yro_C_additional_coins_v33" type="number" value="" style="width:84px;" disabled></div>
    <div class="yro_kv"><label>Merch Used</label><input id="yro_C_merch_used_v33" type="number" value="" style="width:72px;" disabled></div>
    <button class="yro_btn btn-confirm" id="yro_C_plan_v33">Plan</button>
    <button class="yro_btn btn-confirm" id="yro_C_exec_v33">Execute</button>
  </div>
</div>
...
<div class="yro_mode_row ${st.orchestrator.mode === 'flat' ? 'active' : ''}" data-mode="flat">
  ...
  <div class="yro_mode_controls">
    <div class="yro_kv"><label>Parents</label><select id="yro_D_parents_v33">${optionsHTML(st.groups.D_parents)}</select></div>
    <button class="yro_mini" id="pick_D_parents_v33">Pick...</button>
    <div class="yro_kv"><label>Children</label><select id="yro_D_children_v33">${optionsHTML(st.groups.D_children)}</select></div>
    <button class="yro_mini" id="pick_D_children_v33">Pick...</button>
    <div class="yro_kv"><label>Surplus</label><select id="yro_D_surplus_v33">${optionsHTML(st.groups.D_surplus)}</select></div>
    <button class="yro_mini" id="pick_D_surplus_v33">Pick...</button>
    <div class="yro_kv"><label>Parent Reserve %</label><input id="yro_D_parent_reserve_v33" type="number" min="0" max="100" step="1" value="${st.modeD.parentReservePct}" style="width:70px;"></div>
    <div class="yro_kv"><label>Depot Cap %</label><input id="yro_D_depot_cap_v33" type="number" min="0" max="100" step="1" value="${st.modeD.depotCapPct}" style="width:70px;"></div>
    <div class="yro_kv"><label>Computed Flat Target</label><input id="yro_D_computed_flat_v33" type="number" value="" style="width:98px;" disabled></div>
    <div class="yro_kv"><label>Child Merch Used</label><input id="yro_D_child_merch_v33" type="number" value="" style="width:70px;" disabled></div>
    <div class="yro_kv"><label>Parent Merch Used</label><input id="yro_D_parent_merch_v33" type="number" value="" style="width:78px;" disabled></div>
    <button class="yro_btn btn-confirm" id="yro_D_plan_v33">Plan</button>
    <button class="yro_btn btn-confirm" id="yro_D_exec_v33">Execute</button>
  </div>
</div>
    `;
  }
...
<div class="yro_modal_head">
  ...
  <button class="yro_btn" id="yro_picker_close_v33">Ã¢Å“â€“</button>
</div>
<div class="yro_modal_body">
  <div class="yro_modal_toolbar">
    <span class="yro_small"><b>Search:</b></span>
    <input type="text" id="yro_picker_search_v33" style="width:220px;" placeholder="name / coord">
    <button class="yro_btn" id="yro_picker_all_v33">Select all</button>
    <button class="yro_btn" id="yro_picker_none_v33">Select none</button>
    <span class="yro_small" id="yro_picker_count_v33"></span>
  </div>
  <table class="yro_modal_list" id="yro_picker_tbl_v33">
    <tr><th></th><th>Village</th><th>Coord</th><th class="yro_right">Storage</th></tr>
  </table>
</div>
<div class="yro_modal_foot">
  <button class="yro_btn" id="yro_picker_cancel_v33">Cancel</button>
  <button class="yro_btn btn-confirm" id="yro_picker_save_v33">Kaydet</button>
</div>
    `;
    ...
    function updateCount() {
      var el = box.querySelector('#yro_picker_count_v33');
      if (el) el.textContent = 'Selected: ' + selected.size;
    }

    function renderList(filterText) {
      filterText = String(filterText || '').toLowerCase();
      var tbl = box.querySelector('#yro_picker_tbl_v33');
      if (!tbl) return;
...
<td class="yro_right">${Y.formatTwNumber(storage)}</td>
    ...
    box.querySelector('#yro_picker_close_v33').addEventListener('click', close);
    box.querySelector('#yro_picker_cancel_v33').addEventListener('click', close);

    box.querySelector('#yro_picker_all_v33').addEventListener('click', function () {
      candidates.forEach(function (v) { selected.add(String(v.id)); });
      renderList(box.querySelector('#yro_picker_search_v33').value);
    });

    box.querySelector('#yro_picker_none_v33').addEventListener('click', function () {
      selected.clear();
      renderList(box.querySelector('#yro_picker_search_v33').value);
    });

    box.querySelector('#yro_picker_save_v33').addEventListener('click', function () {
      var ids = Array.from(selected).map(function (s) { return Y.safeInt(s, 0); }).filter(Boolean);
      try { onSaveCallback(ids); } catch (e) {}
      close();
    });

    box.querySelector('#yro_picker_search_v33').addEventListener('input', Y.debounce(function (e) {
...
<tr class="yro_total_row">
  ...
  function renderPlanTables(plan, snapshotsById) {
    var metaEl = Y.qs('#yro_plan_meta_v33');
    var diagEl = Y.qs('#yro_plan_diag_v33');
    var tTbl = Y.qs('#yro_plan_target_tbl_v33');
    var sTbl = Y.qs('#yro_plan_surplus_tbl_v33');
    var shTbl = Y.qs('#yro_plan_ship_tbl_v33');
    var targetTitleEl = Y.qs('#yro_plan_target_title_v33');
    var surplusTitleEl = Y.qs('#yro_plan_surplus_title_v33');
    var shipTitleEl = Y.qs('#yro_plan_ship_title_v33');
    var copyTargetEl = Y.qs('#yro_copy_plan_target_v33');
    var copySurplusEl = Y.qs('#yro_copy_plan_surplus_v33');
    var copyShipEl = Y.qs('#yro_copy_plan_ship_v33');

    function renderEmpty() {
      var modeALabelEl = Y.qs('#yro_A_computed_label_v33');
      var modeAFillEl = Y.qs('#yro_A_computed_fill_v33');
      var modeAMerchEl = Y.qs('#yro_A_merch_used_v33');
      var modeBFillEl = Y.qs('#yro_B_computed_fill_v33');
      var modeBChildMerchEl = Y.qs('#yro_B_child_merch_v33');
      var modeBParentMerchEl = Y.qs('#yro_B_parent_merch_v33');
      var modeDFlatEl = Y.qs('#yro_D_computed_flat_v33');
      var modeDChildMerchEl = Y.qs('#yro_D_child_merch_v33');
      var modeDParentMerchEl = Y.qs('#yro_D_parent_merch_v33');
      var modeCCoinsEl = Y.qs('#yro_C_additional_coins_v33');
      var modeCMerchEl = Y.qs('#yro_C_merch_used_v33');
    ...
    if (String(plan.mode || '').toLowerCase() === 'balance' && plan.targetSummary) {
      ...
      var modeAFillEl = Y.qs('#yro_A_computed_fill_v33');
      var modeAMerchEl = Y.qs('#yro_A_merch_used_v33');
      var computedFillEl0 = Y.qs('#yro_B_computed_fill_v33');
      var childMerchEl0 = Y.qs('#yro_B_child_merch_v33');
      var parentMerchEl0 = Y.qs('#yro_B_parent_merch_v33');
      var modeDFlatEl0 = Y.qs('#yro_D_computed_flat_v33');
      var modeDChildMerchEl0 = Y.qs('#yro_D_child_merch_v33');
      var modeDParentMerchEl0 = Y.qs('#yro_D_parent_merch_v33');
      var coinAddEl0 = Y.qs('#yro_C_additional_coins_v33');
      var coinMerchEl0 = Y.qs('#yro_C_merch_used_v33');
...
<tr>
  ...
  <td class="yro_right">${Y.formatTwNumber(r.merchUsed || 0)}</td>
      ...
      var computedFillEl = Y.qs('#yro_B_computed_fill_v33');
      var childMerchEl = Y.qs('#yro_B_child_merch_v33');
      var parentMerchEl = Y.qs('#yro_B_parent_merch_v33');
      var modeAFillEl2 = Y.qs('#yro_A_computed_fill_v33');
      var modeAMerchEl2 = Y.qs('#yro_A_merch_used_v33');
      var modeDFlatEl1 = Y.qs('#yro_D_computed_flat_v33');
      var modeDChildMerchEl1 = Y.qs('#yro_D_child_merch_v33');
      var modeDParentMerchEl1 = Y.qs('#yro_D_parent_merch_v33');
      var coinAddEl1 = Y.qs('#yro_C_additional_coins_v33');
      var coinMerchEl1 = Y.qs('#yro_C_merch_used_v33');
...
<tr>
  ...
  <td class="yro_right">${Y.formatTwNumber(r.merchUsed || 0)}</td>
      ...
      var computedFillElD0 = Y.qs('#yro_B_computed_fill_v33');
      var childMerchElD0 = Y.qs('#yro_B_child_merch_v33');
      var parentMerchElD0 = Y.qs('#yro_B_parent_merch_v33');
      var modeAFillElD0 = Y.qs('#yro_A_computed_fill_v33');
      var modeAMerchElD0 = Y.qs('#yro_A_merch_used_v33');
      var modeDFlatEl = Y.qs('#yro_D_computed_flat_v33');
      var modeDChildMerchEl = Y.qs('#yro_D_child_merch_v33');
      var modeDParentMerchEl = Y.qs('#yro_D_parent_merch_v33');
      var modeCCoinsElD0 = Y.qs('#yro_C_additional_coins_v33');
      var modeCMerchElD0 = Y.qs('#yro_C_merch_used_v33');
...
<tr>
  ...
  <td class="yro_right">${Y.formatTwNumber(r.merchUsed || 0)}</td>
      ...
      var computedFillElC0 = Y.qs('#yro_B_computed_fill_v33');
      var childMerchElC0 = Y.qs('#yro_B_child_merch_v33');
      var parentMerchElC0 = Y.qs('#yro_B_parent_merch_v33');
      var modeAFillElC0 = Y.qs('#yro_A_computed_fill_v33');
      var modeAMerchElC0 = Y.qs('#yro_A_merch_used_v33');
      var modeDFlatElC0 = Y.qs('#yro_D_computed_flat_v33');
      var modeDChildMerchElC0 = Y.qs('#yro_D_child_merch_v33');
      var modeDParentMerchElC0 = Y.qs('#yro_D_parent_merch_v33');
      var modeCCoinsEl = Y.qs('#yro_C_additional_coins_v33');
      var modeCMerchEl = Y.qs('#yro_C_merch_used_v33');
...
<tr>
  ...
  <td class="yro_right">${Y.formatTwNumber(r.merchUsed || 0)}</td>
      ...
      var computedFillEl2 = Y.qs('#yro_B_computed_fill_v33');
      var childMerchEl2 = Y.qs('#yro_B_child_merch_v33');
      var parentMerchEl2 = Y.qs('#yro_B_parent_merch_v33');
      var modeAFillEl3 = Y.qs('#yro_A_computed_fill_v33');
      var modeAMerchEl3 = Y.qs('#yro_A_merch_used_v33');
      var modeDFlatEl2 = Y.qs('#yro_D_computed_flat_v33');
      var modeDChildMerchEl2 = Y.qs('#yro_D_child_merch_v33');
      var modeDParentMerchEl2 = Y.qs('#yro_D_parent_merch_v33');
      var modeCCoinsEl2 = Y.qs('#yro_C_additional_coins_v33');
      var modeCMerchEl2 = Y.qs('#yro_C_merch_used_v33');
...
(function () {
  ...
  async function loadTables(forceGroupFetch) {
    ...
    var t1title = Y.qs('#yro_t1_title_v33');
    ...
    var t2title = Y.qs('#yro_t2_title_v33');
  ...
  function confirmTwoButtons(htmlMsg, onYes, onCancel) {
    ...
    if (window.UI && UI.ConfirmationBox) {
      UI.ConfirmationBox(htmlMsg, actions, 'yro_exec_v33', true);
    } else {
  ...
  async function planFromMode(mode) {
    ...
    if (mode === 'balance') {
      targetGid = getSelValue('#yro_A_target_v33');
      surplusGid = getSelValue('#yro_A_surplus_v33');
      var basisA = String((Y.qs('#yro_A_basis_v33') && Y.qs('#yro_A_basis_v33').value) || st.modeA.balanceBasis || 'fill').toLowerCase() === 'flat' ? 'flat' : 'fill';
      var capA = getNumValue('#yro_A_cap_v33', st.modeA.capPct || 80);
      var depotCapA = getNumValue('#yro_A_depot_cap_v33', st.modeA.depotCapPct || 80);
      var scapA = getNumValue('#yro_A_scap_v33', st.modeA.surplusCapPct || 95);
      ...
      var parentGid = getSelValue('#yro_B_parents_v33');
      var childGid = getSelValue('#yro_B_children_v33');
      surplusGid = getSelValue('#yro_B_surplus_v33');
      var parentReservePct = getNumValue('#yro_B_parent_reserve_v33', st.modeB.parentReservePct || 1);
      var childrenMaxFillPct = getNumValue('#yro_B_child_max_v33', st.modeB.childrenMaxFillPct || 80);
      var surplusCapPct = getNumValue('#yro_B_scap_v33', st.modeB.surplusCapPct || 95);
      ...
      var flatParentGid = getSelValue('#yro_D_parents_v33');
      var flatChildGid = getSelValue('#yro_D_children_v33');
      var flatSurplusGid = getSelValue('#yro_D_surplus_v33');
      var flatParentReservePct = getNumValue('#yro_D_parent_reserve_v33', st.modeD.parentReservePct || 1);
      var depotCapPct = getNumValue('#yro_D_depot_cap_v33', st.modeD.depotCapPct || 80);
      ...
      var sourceGid = getSelValue('#yro_C_sources_v33');
      var coinGid = getSelValue('#yro_C_coin_v33');
      var bufferGid = getSelValue('#yro_C_buffer_v33');
      var sourceReservePct = getNumValue('#yro_C_reserve_v33', st.modeC.sourceReservePct || 1);
      var bufferCapPct = getNumValue('#yro_C_bcap_v33', st.modeC.bufferCapPct || 95);
  ...
  function copyPlanTargetBBCode() {
    ...
    if (mode === 'push') {
      ...
      flashButton('#yro_copy_plan_target_v33', 'Copy CHILDREN');
      copyText(text, 'CHILDREN BBCode copied');
      return;
    }
    if (mode === 'balance') {
      text = buildBalanceTargetTableBBCode(plan);
      flashButton('#yro_copy_plan_target_v33', 'Copy TARGET GROUP');
      copyText(text, 'TARGET GROUP BBCode copied');
      return;
    }
    if (mode === 'coin') {
      text = buildCoinTableBBCode(plan);
      flashButton('#yro_copy_plan_target_v33', 'Copy COIN VILLAGES');
    ...
    flashButton('#yro_copy_plan_target_v33', 'Copy TARGET');
  ...
  function copyPlanSurplusBBCode() {
    ...
    if (mode === 'balance') {
      ...
      flashButton('#yro_copy_plan_surplus_v33', 'Copy SURPLUS');
      copyText(text, 'SURPLUS BBCode copied');
      return;
    }
    if (mode === 'coin') {
      text = buildCoinSourcesBufferBBCode(plan);
      flashButton('#yro_copy_plan_surplus_v33', (plan.bufferSummary && plan.bufferSummary.length) ? 'Copy SOURCES / BUFFER' : 'Copy SOURCES');
  ...
  function copyPlanShipmentsBBCode() {
    ...
    flashButton('#yro_copy_plan_ship_v33', 'Copy SHIPMENTS');
  ...
  function getActiveModeKey() {
    var active = Y.qs('#yro_modes_v33 .yro_mode_row.active');
  ...
  function buildCurrentModeInputRows() {
    ...
    if (mode === 'balance') {
      ...
      return [
        ...
        ['Target', getSelectText('#yro_A_target_v33', st.groups.A_target)],
        ['Surplus', getSelectText('#yro_A_surplus_v33', st.groups.A_surplus)],
        ['Balance Basis', basisA === 'flat' ? 'Equal Flat Amount per Village' : 'Equal Fill % by Storage'],
        ['Cap %', basisA === 'fill' ? getInputText('#yro_A_cap_v33', st.modeA.capPct) : '-'],
        ['Depot Cap %', basisA === 'flat' ? getInputText('#yro_A_depot_cap_v33', st.modeA.depotCapPct) : '-'],
        ['Surplus Cap %', getInputText('#yro_A_scap_v33', st.modeA.surplusCapPct)]
      ];
    }
    if (mode === 'push') {
      return [
        ['Mode', activeModeLabel(mode)],
        ['Parents', getSelectText('#yro_B_parents_v33', st.groups.B_parents)],
        ['Children', getSelectText('#yro_B_children_v33', st.groups.B_children)],
        ['Surplus', getSelectText('#yro_B_surplus_v33', st.groups.B_surplus)],
        ['Parent Reserve %', getInputText('#yro_B_parent_reserve_v33', st.modeB.parentReservePct)],
        ['Children Max Fill %', getInputText('#yro_B_child_max_v33', st.modeB.childrenMaxFillPct)],
        ['Surplus Cap %', getInputText('#yro_B_scap_v33', st.modeB.surplusCapPct)]
      ];
    }
    if (mode === 'flat') {
      return [
        ['Mode', activeModeLabel(mode)],
        ['Parents', getSelectText('#yro_D_parents_v33', st.groups.D_parents)],
        ['Children', getSelectText('#yro_D_children_v33', st.groups.D_children)],
        ['Surplus', getSelectText('#yro_D_surplus_v33', st.groups.D_surplus)],
        ['Parent Reserve %', getInputText('#yro_D_parent_reserve_v33', st.modeD.parentReservePct)],
        ['Depot Cap %', getInputText('#yro_D_depot_cap_v33', st.modeD.depotCapPct)]
      ];
    }
    if (mode === 'coin') {
      return [
        ['Mode', activeModeLabel(mode)],
        ['Sources', getSelectText('#yro_C_sources_v33', st.groups.C_sources)],
        ['Coin', getSelectText('#yro_C_coin_v33', st.groups.C_coin)],
        ['Buffer / Surplus', getSelectText('#yro_C_buffer_v33', st.groups.C_buffer)],
        ['Source Reserve %', getInputText('#yro_C_reserve_v33', st.modeC.sourceReservePct)],
        ['Buffer Cap %', getInputText('#yro_C_bcap_v33', st.modeC.bufferCapPct)]
      ];
    }
    ...
    if (mode === 'balance') {
      ...
      lines.push(buildSelectionTablesMarkdown(
        ...
        [
          ...
          normalization.sharedTargetSurplusIds && normalization.sharedTargetSurplusIds.length
            ? ('Target/Surplus overlap allowed: ' + normalization.sharedTargetSurplusIds.join(', '))
            : 'Target/Surplus overlap allowed: -',
  ...
  async function copyTestResults() {
    try {
      ...
      flashButton('#yro_copy_bb_v33', 'Copy Test Results');
  ...
  function bindEvents() {
    ...
    Y.on(Y.qs('#yro_close_v33'), 'click', function () { Y.destroy(); });
    Y.on(Y.qs('#yro_load_v33'), 'click', function () { loadAll(true); });

    var search = Y.qs('#yro_search_v33');
    if (search) {
    ...
    Y.on(Y.qs('#yro_t1_toggle_v33'), 'click', function () {
      st.ui.minimized1 = !st.ui.minimized1;
      var w = Y.qs('#yro_t1_wrap_v33');
      if (w) w.style.display = st.ui.minimized1 ? 'none' : '';
      var b = Y.qs('#yro_t1_toggle_v33');
      if (b) b.textContent = st.ui.minimized1 ? 'Expand' : 'Minimize';
      Y.saveState();
    });

    Y.on(Y.qs('#yro_t2_toggle_v33'), 'click', function () {
      st.ui.minimized2 = !st.ui.minimized2;
      var w = Y.qs('#yro_t2_wrap_v33');
      if (w) w.style.display = st.ui.minimized2 ? 'none' : '';
      var b = Y.qs('#yro_t2_toggle_v33');
      if (b) b.textContent = st.ui.minimized2 ? 'Expand' : 'Minimize';
      Y.saveState();
    });

    Y.on(Y.qs('#yro_t1_group_sel_v33'), 'change', function (e) {
      st.groups.sel1 = Y.safeInt(e.target.value, 0);
      Y.saveState();
      loadTables(true);
    });

    Y.on(Y.qs('#yro_t2_group_sel_v33'), 'change', function (e) {
      st.groups.sel2 = Y.safeInt(e.target.value, 0);
      Y.saveState();
      loadTables(true);
    });

    Y.on(Y.qs('#yro_t1_pick_v33'), 'click', function () { openPicker('t1'); });
    Y.on(Y.qs('#yro_t2_pick_v33'), 'click', function () { openPicker('t2'); });
    Y.on(Y.qs('#yro_copy_bb_v33'), 'click', function () { copyTestResults(); });
    Y.on(Y.qs('#yro_copy_plan_target_v33'), 'click', function () { copyPlanTargetBBCode(); });
    Y.on(Y.qs('#yro_copy_plan_surplus_v33'), 'click', function () { copyPlanSurplusBBCode(); });
    Y.on(Y.qs('#yro_copy_plan_ship_v33'), 'click', function () { copyPlanShipmentsBBCode(); });

    var modeBox = Y.qs('#yro_modes_v33');
    if (!modeBox) return;
    ...
    Y.on(modeBox, 'click', function (e) {
      ...
      if (t.id === 'yro_A_plan_v33') return planFromMode('balance');
      if (t.id === 'yro_B_plan_v33') return planFromMode('push');
      if (t.id === 'yro_D_plan_v33') return planFromMode('flat');
      if (t.id === 'yro_C_plan_v33') return planFromMode('coin');

      if (t.id === 'yro_A_exec_v33' || t.id === 'yro_B_exec_v33' || t.id === 'yro_D_exec_v33' || t.id === 'yro_C_exec_v33') return executePlan();

      if (String(t.id || '').startsWith('pick_') && String(t.id || '').endsWith('_v33')) {
        var key = String(t.id).replace('pick_', '').replace('_v33', '');
      ...
      if (row && row.getAttribute) {
        ...
        if (mode) {
          st.orchestrator.mode = mode;
          Y.saveState();
          Y.qsa('#yro_modes_v33 .yro_mode_row').forEach(function (r) { r.classList.remove('active'); });
    ...
    Y.on(modeBox, 'change', function (e) {
      ...
      if (t.id === 'yro_A_target_v33') st.groups.A_target = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_A_surplus_v33') st.groups.A_surplus = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_B_parents_v33') st.groups.B_parents = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_B_children_v33') st.groups.B_children = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_B_surplus_v33') st.groups.B_surplus = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_D_parents_v33') st.groups.D_parents = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_D_children_v33') st.groups.D_children = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_D_surplus_v33') st.groups.D_surplus = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_C_sources_v33') st.groups.C_sources = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_C_coin_v33') st.groups.C_coin = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_C_buffer_v33') st.groups.C_buffer = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_A_basis_v33') { st.modeA.balanceBasis = String(t.value || '').toLowerCase() === 'flat' ? 'flat' : 'fill'; rerenderModes = true; }
      else if (t.id === 'yro_A_cap_v33') st.modeA.capPct = Y.safeInt(t.value, st.modeA.capPct);
      else if (t.id === 'yro_A_depot_cap_v33') st.modeA.depotCapPct = Y.safeInt(t.value, st.modeA.depotCapPct);
      else if (t.id === 'yro_A_scap_v33') st.modeA.surplusCapPct = Y.safeInt(t.value, st.modeA.surplusCapPct);
      else if (t.id === 'yro_B_parent_reserve_v33') st.modeB.parentReservePct = Y.safeInt(t.value, st.modeB.parentReservePct);
      else if (t.id === 'yro_B_child_max_v33') st.modeB.childrenMaxFillPct = Y.safeInt(t.value, st.modeB.childrenMaxFillPct);
      else if (t.id === 'yro_B_scap_v33') st.modeB.surplusCapPct = Y.safeInt(t.value, st.modeB.surplusCapPct);
      else if (t.id === 'yro_D_parent_reserve_v33') st.modeD.parentReservePct = Y.safeInt(t.value, st.modeD.parentReservePct);
      else if (t.id === 'yro_D_depot_cap_v33') st.modeD.depotCapPct = Y.safeInt(t.value, st.modeD.depotCapPct);
      else if (t.id === 'yro_C_reserve_v33') st.modeC.sourceReservePct = Y.safeInt(t.value, st.modeC.sourceReservePct);
      else if (t.id === 'yro_C_bcap_v33') st.modeC.bufferCapPct = Y.safeInt(t.value, st.modeC.bufferCapPct);
