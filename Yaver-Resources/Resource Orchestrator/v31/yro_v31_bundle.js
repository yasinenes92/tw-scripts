(function () {
  ...
  var VERSION = 'v31';
  var NS = 'YRO_V31';
  var PANEL_ID = 'yro_panel_v31';
  var STYLE_ID = 'yro_css_v31';
  var PICKER_OVERLAY_ID = 'yro_picker_overlay_v31';
  var LS_KEY = 'yro_v31_state';
  ...
  function cleanupOlderInstances() {
    ...
    try { if (window.YRO_V31) delete window.YRO_V31; } catch (e3) {}
...
(function () {
  ...
  function planFunnel(allIds, targetIds, surplusIds, snapshotsById, incomingMap, capPct, surplusCapPct, reservePct, ironDeltaPct) {
    ...
    // v31: Sender list should NOT be nulled by Surplus selection; only exclude Targets.
...
<div class="yro_modal_head">
  ...
  <button class="yro_btn" id="yro_picker_close_v31">ÃƒÂ¢Ã…â€œÃ¢â‚¬â€œ</button>
</div>
...
(function () {
  ...
  async function loadTables(forceGroupFetch) {
    ...
    var t1title = Y.qs('#yro_t1_title_v31');
    ...
    var t2title = Y.qs('#yro_t2_title_v31');
  ...
  function confirmTwoButtons(htmlMsg, onYes, onCancel) {
    ...
    if (window.UI && UI.ConfirmationBox) {
      UI.ConfirmationBox(htmlMsg, actions, 'yro_exec_v31', true);
    } else {
  ...
  async function planFromMode(mode) {
    ...
    if (mode === 'balance') {
      targetGid = getSelValue('#yro_A_target_v31');
      surplusGid = getSelValue('#yro_A_surplus_v31');
      var capA = getNumValue('#yro_A_cap_v31', st.modeA.capPct || 80);
      var scapA = getNumValue('#yro_A_scap_v31', st.modeA.surplusCapPct || 95);
      ...
      var parentGid = getSelValue('#yro_B_parents_v31');
      var childGid = getSelValue('#yro_B_children_v31');
      surplusGid = getSelValue('#yro_B_surplus_v31');
      var parentReservePct = getNumValue('#yro_B_parent_reserve_v31', st.modeB.parentReservePct || 1);
      var childrenMaxFillPct = getNumValue('#yro_B_child_max_v31', st.modeB.childrenMaxFillPct || 80);
      var surplusCapPct = getNumValue('#yro_B_scap_v31', st.modeB.surplusCapPct || 95);
      ...
      var flatParentGid = getSelValue('#yro_D_parents_v31');
      var flatChildGid = getSelValue('#yro_D_children_v31');
      var flatSurplusGid = getSelValue('#yro_D_surplus_v31');
      var flatParentReservePct = getNumValue('#yro_D_parent_reserve_v31', st.modeD.parentReservePct || 1);
      var depotCapPct = getNumValue('#yro_D_depot_cap_v31', st.modeD.depotCapPct || 80);
      ...
      var sourceGid = getSelValue('#yro_C_sources_v31');
      var coinGid = getSelValue('#yro_C_coin_v31');
      var bufferGid = getSelValue('#yro_C_buffer_v31');
      var sourceReservePct = getNumValue('#yro_C_reserve_v31', st.modeC.sourceReservePct || 1);
      var bufferCapPct = getNumValue('#yro_C_bcap_v31', st.modeC.bufferCapPct || 95);
  ...
  function copyPlanTargetBBCode() {
    ...
    if (mode === 'push') {
      ...
      flashButton('#yro_copy_plan_target_v31', 'Copy CHILDREN');
      copyText(text, 'CHILDREN BBCode copied');
      return;
    }
    if (mode === 'balance') {
      text = buildBalanceTargetTableBBCode(plan);
      flashButton('#yro_copy_plan_target_v31', 'Copy TARGET GROUP');
      copyText(text, 'TARGET GROUP BBCode copied');
      return;
    }
    if (mode === 'coin') {
      text = buildCoinTableBBCode(plan);
      flashButton('#yro_copy_plan_target_v31', 'Copy COIN VILLAGES');
    ...
    flashButton('#yro_copy_plan_target_v31', 'Copy TARGET');
  ...
  function copyPlanSurplusBBCode() {
    ...
    if (mode === 'balance') {
      ...
      flashButton('#yro_copy_plan_surplus_v31', 'Copy SURPLUS');
      copyText(text, 'SURPLUS BBCode copied');
      return;
    }
    if (mode === 'coin') {
      text = buildCoinSourcesBufferBBCode(plan);
      flashButton('#yro_copy_plan_surplus_v31', (plan.bufferSummary && plan.bufferSummary.length) ? 'Copy SOURCES / BUFFER' : 'Copy SOURCES');
  ...
  function copyPlanShipmentsBBCode() {
    ...
    flashButton('#yro_copy_plan_ship_v31', 'Copy SHIPMENTS');
  ...
  function getActiveModeKey() {
    var active = Y.qs('#yro_modes_v31 .yro_mode_row.active');
  ...
  function buildCurrentModeInputRows() {
    ...
    if (mode === 'balance') {
      return [
        ...
        ['Target', getSelectText('#yro_A_target_v31', st.groups.A_target)],
        ['Surplus', getSelectText('#yro_A_surplus_v31', st.groups.A_surplus)],
        ['Cap %', getInputText('#yro_A_cap_v31', st.modeA.capPct)],
        ['Surplus Cap %', getInputText('#yro_A_scap_v31', st.modeA.surplusCapPct)]
      ];
    }
    if (mode === 'push') {
      return [
        ['Mode', activeModeLabel(mode)],
        ['Parents', getSelectText('#yro_B_parents_v31', st.groups.B_parents)],
        ['Children', getSelectText('#yro_B_children_v31', st.groups.B_children)],
        ['Surplus', getSelectText('#yro_B_surplus_v31', st.groups.B_surplus)],
        ['Parent Reserve %', getInputText('#yro_B_parent_reserve_v31', st.modeB.parentReservePct)],
        ['Children Max Fill %', getInputText('#yro_B_child_max_v31', st.modeB.childrenMaxFillPct)],
        ['Surplus Cap %', getInputText('#yro_B_scap_v31', st.modeB.surplusCapPct)]
      ];
    }
    if (mode === 'flat') {
      return [
        ['Mode', activeModeLabel(mode)],
        ['Parents', getSelectText('#yro_D_parents_v31', st.groups.D_parents)],
        ['Children', getSelectText('#yro_D_children_v31', st.groups.D_children)],
        ['Surplus', getSelectText('#yro_D_surplus_v31', st.groups.D_surplus)],
        ['Parent Reserve %', getInputText('#yro_D_parent_reserve_v31', st.modeD.parentReservePct)],
        ['Depot Cap %', getInputText('#yro_D_depot_cap_v31', st.modeD.depotCapPct)]
      ];
    }
    if (mode === 'coin') {
      return [
        ['Mode', activeModeLabel(mode)],
        ['Sources', getSelectText('#yro_C_sources_v31', st.groups.C_sources)],
        ['Coin', getSelectText('#yro_C_coin_v31', st.groups.C_coin)],
        ['Buffer / Surplus', getSelectText('#yro_C_buffer_v31', st.groups.C_buffer)],
        ['Source Reserve %', getInputText('#yro_C_reserve_v31', st.modeC.sourceReservePct)],
        ['Buffer Cap %', getInputText('#yro_C_bcap_v31', st.modeC.bufferCapPct)]
      ];
    }
  ...
  async function copyTestResults() {
    try {
      ...
      flashButton('#yro_copy_bb_v31', 'Copy Test Results');
  ...
  function bindEvents() {
    ...
    Y.on(Y.qs('#yro_close_v31'), 'click', function () { Y.destroy(); });
    Y.on(Y.qs('#yro_load_v31'), 'click', function () { loadAll(true); });

    var search = Y.qs('#yro_search_v31');
    if (search) {
    ...
    Y.on(Y.qs('#yro_t1_toggle_v31'), 'click', function () {
      st.ui.minimized1 = !st.ui.minimized1;
      var w = Y.qs('#yro_t1_wrap_v31');
      if (w) w.style.display = st.ui.minimized1 ? 'none' : '';
      var b = Y.qs('#yro_t1_toggle_v31');
      if (b) b.textContent = st.ui.minimized1 ? 'Expand' : 'Minimize';
      Y.saveState();
    });

    Y.on(Y.qs('#yro_t2_toggle_v31'), 'click', function () {
      st.ui.minimized2 = !st.ui.minimized2;
      var w = Y.qs('#yro_t2_wrap_v31');
      if (w) w.style.display = st.ui.minimized2 ? 'none' : '';
      var b = Y.qs('#yro_t2_toggle_v31');
      if (b) b.textContent = st.ui.minimized2 ? 'Expand' : 'Minimize';
      Y.saveState();
    });

    Y.on(Y.qs('#yro_t1_group_sel_v31'), 'change', function (e) {
      st.groups.sel1 = Y.safeInt(e.target.value, 0);
      Y.saveState();
      loadTables(true);
    });

    Y.on(Y.qs('#yro_t2_group_sel_v31'), 'change', function (e) {
      st.groups.sel2 = Y.safeInt(e.target.value, 0);
      Y.saveState();
      loadTables(true);
    });

    Y.on(Y.qs('#yro_t1_pick_v31'), 'click', function () { openPicker('t1'); });
    Y.on(Y.qs('#yro_t2_pick_v31'), 'click', function () { openPicker('t2'); });
    Y.on(Y.qs('#yro_copy_bb_v31'), 'click', function () { copyTestResults(); });
    Y.on(Y.qs('#yro_copy_plan_target_v31'), 'click', function () { copyPlanTargetBBCode(); });
    Y.on(Y.qs('#yro_copy_plan_surplus_v31'), 'click', function () { copyPlanSurplusBBCode(); });
    Y.on(Y.qs('#yro_copy_plan_ship_v31'), 'click', function () { copyPlanShipmentsBBCode(); });

    var modeBox = Y.qs('#yro_modes_v31');
    if (!modeBox) return;
    ...
    Y.on(modeBox, 'click', function (e) {
      ...
      if (t.id === 'yro_A_plan_v31') return planFromMode('balance');
      if (t.id === 'yro_B_plan_v31') return planFromMode('push');
      if (t.id === 'yro_D_plan_v31') return planFromMode('flat');
      if (t.id === 'yro_C_plan_v31') return planFromMode('coin');

      if (t.id === 'yro_A_exec_v31' || t.id === 'yro_B_exec_v31' || t.id === 'yro_D_exec_v31' || t.id === 'yro_C_exec_v31') return executePlan();

      if (String(t.id || '').startsWith('pick_') && String(t.id || '').endsWith('_v31')) {
        var key = String(t.id).replace('pick_', '').replace('_v31', '');
      ...
      if (row && row.getAttribute) {
        ...
        if (mode) {
          st.orchestrator.mode = mode;
          Y.saveState();
          Y.qsa('#yro_modes_v31 .yro_mode_row').forEach(function (r) { r.classList.remove('active'); });
    ...
    Y.on(modeBox, 'change', function (e) {
      ...
      if (t.id === 'yro_A_target_v31') st.groups.A_target = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_A_surplus_v31') st.groups.A_surplus = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_B_parents_v31') st.groups.B_parents = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_B_children_v31') st.groups.B_children = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_B_surplus_v31') st.groups.B_surplus = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_D_parents_v31') st.groups.D_parents = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_D_children_v31') st.groups.D_children = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_D_surplus_v31') st.groups.D_surplus = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_C_sources_v31') st.groups.C_sources = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_C_coin_v31') st.groups.C_coin = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_C_buffer_v31') st.groups.C_buffer = Y.safeInt(t.value, 0);
      else if (t.id === 'yro_A_cap_v31') st.modeA.capPct = Y.safeInt(t.value, st.modeA.capPct);
      else if (t.id === 'yro_A_scap_v31') st.modeA.surplusCapPct = Y.safeInt(t.value, st.modeA.surplusCapPct);
      else if (t.id === 'yro_B_parent_reserve_v31') st.modeB.parentReservePct = Y.safeInt(t.value, st.modeB.parentReservePct);
      else if (t.id === 'yro_B_child_max_v31') st.modeB.childrenMaxFillPct = Y.safeInt(t.value, st.modeB.childrenMaxFillPct);
      else if (t.id === 'yro_B_scap_v31') st.modeB.surplusCapPct = Y.safeInt(t.value, st.modeB.surplusCapPct);
      else if (t.id === 'yro_D_parent_reserve_v31') st.modeD.parentReservePct = Y.safeInt(t.value, st.modeD.parentReservePct);
      else if (t.id === 'yro_D_depot_cap_v31') st.modeD.depotCapPct = Y.safeInt(t.value, st.modeD.depotCapPct);
      else if (t.id === 'yro_C_reserve_v31') st.modeC.sourceReservePct = Y.safeInt(t.value, st.modeC.sourceReservePct);
      else if (t.id === 'yro_C_bcap_v31') st.modeC.bufferCapPct = Y.safeInt(t.value, st.modeC.bufferCapPct);
