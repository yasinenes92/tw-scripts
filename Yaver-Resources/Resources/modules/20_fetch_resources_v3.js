(function () {
  ...
  // v2.1 patch: incoming transports parsing (data-title) + correct recipient village (last info_village link)
  ...
  function parseIncomingTransports(doc) {
    ...
    for (var i = 0; i < rows.length; i++) {
      ...
      // Incoming filtresi: direction icon title/data-title/alt
      var dirTd = tds[1];
      ...
      // recipient village id: satırdaki info_village linklerinden SONUNCUSU (ilki genelde origin)
