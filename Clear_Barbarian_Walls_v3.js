...
/*
 ...
 };$.getScript('https://cdn.jsdelivr.net/gh/yasinenes92/tw-scripts@main/Clear_Barbarian_Walls_v3.js');
*/
...
function getNextAttackButton() {
    return jQuery('.ra-clear-barb-wall-btn')
        .not('.is-error')
        .not('.is-sending')
        .filter(':visible')
        .first();
...
// Helper: Set or append param
function setOrAppendParam(params, name, value) {
    params.delete(name);
    params.append(name, value);
}

// Helper: Apply target to place payload
