...
var version = "5.0.0";
var scriptName = "LA Enhancer Smart (5.0.0)";
...
async function smartFetchOffensiveGroupId() {
    ...
    if (!resolvedIds.length) {
        throw new Error("Could not resolve the static group id from the exact Offensive group entry.");
    }
    if (resolvedIds.length > 1) {
        throw new Error("Conflicting Offensive group ids were found: " + resolvedIds.join(", ") + ".");
    }
