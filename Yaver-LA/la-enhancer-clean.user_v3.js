// ==UserScript==
// @name         LA Enhancer Clean Rebuild v3
// @namespace    https://github.com/yasinenes92/tw-scripts
// @version      3.0.0
// @description  Clean standalone Loot Assistant enhancer with profiles, reliable game-time filters, safer hotkeys, and auto redirect to LA.
...
(function () {
  ...
  const SCRIPT_ID = 'la-enhancer-clean-v3';
  const UI_ID = 'lae3_settingsDiv';
  const STYLE_ID = 'lae3_style';
  const HIDE_CLASS = 'lae3-filtered-out';
  const TOP_CLASS = 'lae3-top-row';
  const ROW_NUM_CLASS = 'lae3-row-num';
  const HOLD_INTERVAL_MS = 160;

  const PROFILE_PREFIX = 'LAE3_PROFILE_';
  const PROFILE_LIST_KEY = 'LAE3_PROFILE_LIST';
  const DEFAULT_PROFILE_KEY = 'LAE3_DEFAULT_PROFILE';
  const LAST_PROFILE_KEY = 'LAE3_LAST_PROFILE';
  const KEYS_KEY = 'LAE3_KEYS';
  const LAST_SENT_PREFIX = 'LAE3_LAST_SENT_';

  const TEXT = {
    title: 'LA Enhancer',
    versionTag: 'clean rebuild v3',
    filterHelp: 'Checked report colors are hidden. Numeric rules also hide rows that match the rule.',
    profileHelp: 'Profiles store the settings shown in the panel.',
    continentHelp: 'Use continent codes separated by dots. Example: 62.63.72',
    recentHelp: 'Recently sent uses game time only and only counts sends made by this v3 script.',
    ...
    recentFresh: 'Recently sent history starts fresh in v3.'
  };
  ...
  if (window.LAEnhancerCleanV3 && typeof window.LAEnhancerCleanV3.destroy === 'function') {
    window.LAEnhancerCleanV3.destroy();
  }
  ...
  function boot() {
    try {
      ensureStorage();
      const availableProfiles = getProfileList();
      ...
      state.profileName = availableProfiles.includes(lastProfile) ? lastProfile : defaultProfile;
      if (!availableProfiles.includes(state.profileName)) state.profileName = 'Default';
  ...
  function destroy() {
    ...
    delete window.LAEnhancerCleanV3;
  }
  ...
  function injectStyle() {
    ...
    style.id = STYLE_ID;
    style.textContent = `
      #${UI_ID} .lae3-small { width: 42px; }
      #${UI_ID} .lae3-medium { width: 64px; }
      #${UI_ID} .lae3-hotkey { width: 52px; text-align:center; }
      #${UI_ID} .lae3-collapse {
      ...
      #${UI_ID} .lae3-collapse a { text-decoration:none; font-weight:bold; }
      #${UI_ID} .lae3-note {
      ...
      #${UI_ID} .lae3-title-suffix { font-weight:normal; }
      #${UI_ID} .lae3-right { float:right; }
      #${UI_ID} .lae3-left { float:left; }
      #${UI_ID} .lae3-clearfix::after { content:''; display:block; clear:both; }
      #${UI_ID} .lae3-hotkey-table td { padding:2px 4px; }
      #${UI_ID} .lae3-warning {
  ...
  function buildUi() {
        ...
        <thead>
          <tr>
            <th colspan="5" class="vis" style="padding:0;">
              <h4>
                ${TEXT.title}
                <span class="lae3-title-suffix">(${TEXT.versionTag})</span>
                <span class="lae3-right">
                  <div class="lae3-collapse"><a href="#" data-target="lae3_body" data-open="-" data-closed="+">-</a></div>
                </span>
              </h4>
            </th>
          </tr>
        ...
        <tbody id="lae3_body">
          <tr>
            <td style="min-width:210px;">
              ...
              &nbsp;<input type="text" id="start_page" class="lae3-small" maxlength="3">
              &nbsp;<span>${TEXT.endPage}</span>
              &nbsp;<input type="text" id="end_page" class="lae3-small" maxlength="5">
            </td>
            <td colspan="3">
              <span style="font-weight:bold">${TEXT.filters}</span>
              <img src="graphic/questionmark.png" width="13" height="13" id="lae3_filter_help">
              <span class="lae3-help">${TEXT.filterHelp}</span>
            </td>
          ...
          <tr>
            ...
            <td>
              <input type="radio" name="lae3_hauls" id="full"><label for="full"><img src="graphic/max_loot/1.png"> ${TEXT.full}</label>
              &nbsp;
              <input type="radio" name="lae3_hauls" id="partial"><label for="partial"><img src="graphic/max_loot/0.png"> ${TEXT.partial}</label>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              ...
              &nbsp;<input type="text" id="attack_value" class="lae3-small" maxlength="3">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              ...
              &nbsp;<input type="text" id="wall_value" class="lae3-small" maxlength="3">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              ...
              &nbsp;<input type="text" id="distance_value" class="lae3-medium" maxlength="6">
            </td>
          </tr>
          ...
          <tr>
            ...
            <td colspan="3">
              ...
              &nbsp;<img src="graphic/questionmark.png" width="13" height="13" id="lae3_continent_help">
            </td>
          </tr>

          <tr>
            <td><input type="checkbox" id="next_village_scouts"><input type="text" id="scouts_left" class="lae3-small"> ${TEXT.nextVillageScouts}</td>
          ...
          <tr>
            <td><input type="checkbox" id="next_village_farming_troops"><input type="text" id="farming_troops_left" class="lae3-small"> ${TEXT.nextVillageTroops}</td>
            ...
            <td colspan="3">
              ...
              &nbsp;<input type="text" id="time_value" class="lae3-small" maxlength="4">
              &nbsp;${TEXT.minutes}
            </td>
          </tr>
          ...
          <tr>
            ...
            <td colspan="3">
              ...
              &nbsp;${TEXT.recentFarms}
              &nbsp;<input type="text" id="hide_recent_time" class="lae3-small">
              &nbsp;${TEXT.minutes}
              &nbsp;<img src="graphic/questionmark.png" width="13" height="13" id="lae3_recent_help">
            </td>
          </tr>
          ...
          <tr>
            <td rowspan="4">
              <table class="lae3-hotkey-table">
                ...
                <tr>
                  <td><input type="text" id="hotkey_value_a" class="lae3-hotkey" readonly></td>
                  <td><input type="text" id="hotkey_value_b" class="lae3-hotkey" readonly></td>
                  <td><input type="text" id="hotkey_value_c" class="lae3-hotkey" readonly></td>
                  <td><input type="text" id="hotkey_value_master" class="lae3-hotkey" readonly></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan="2"><input type="text" id="hotkey_value_skip" class="lae3-hotkey" readonly></td>
                  <td><input type="text" id="hotkey_value_left" class="lae3-hotkey" readonly></td>
                  <td><input type="text" id="hotkey_value_right" class="lae3-hotkey" readonly></td>
                </tr>
              </table>
              <span class="lae3-note">Default keys: Q / E / R / Enter / X / J / L</span>
            </td>
          ...
          <tr>
            <td colspan="5" class="lae3-clearfix">
              <div class="lae3-left">
                ...
                <span class="lae3-status" id="lae3_status"></span>
              </div>
              <div class="lae3-right">
                <img src="graphic/questionmark.png" width="13" height="13" id="lae3_profile_help">
    ...
    if (nativeVis) {
      ...
      if (firstHeader && tableBody && !tableBody.id) {
        tableBody.id = 'lae3_native_body';
        tableBody.style.display = 'none';
        const toggle = document.createElement('div');
        toggle.className = 'lae3-collapse';
        toggle.innerHTML = `<a href="#" data-target="lae3_native_body" data-open="+" data-closed="-">+</a>`;
  ...
  function bindUi() {
    ...
    document.querySelectorAll(`#${UI_ID} .lae3-collapse a`).forEach(a => {
    ...
    addTooltip('lae3_filter_help', TEXT.filterHelp);
    addTooltip('lae3_profile_help', TEXT.profileHelp);
    addTooltip('lae3_continent_help', TEXT.continentHelp);
    addTooltip('lae3_recent_help', TEXT.recentHelp);
  }
  ...
  async function applySettings() {
    ...
    highlightTopRow();
    maybeGoNextVillage();
    setStatus(`Visible ${summary.visible}/${summary.total} | hidden ${summary.hidden} | walls ${summary.reasons.walls || 0} | dist ${summary.reasons.distances || 0} | recent ${summary.reasons.recent || 0}`);
  ...
  async function fetchFarmPage(page, order, direction) {
    ...
    const villageId = window.game_data?.village?.id || new URL(window.location.href).searchParams.get('village') || '';
  ...
  function sendTopRow(buttonName) {
    ...
    if (nowMs - state.lastActionAt < 120) return;
  ...
  function masterSendTopRow() {
    ...
    const data = parseVillageRow(row, getGameClock().now);
    const currentGameEpoch = getGameClock().epoch;
    const recentMap = getRecentSentMap(currentGameEpoch);
